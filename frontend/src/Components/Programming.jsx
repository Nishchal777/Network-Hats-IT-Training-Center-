...
function Programming() {
  return (
    <div className="px-4 lg:px-24 py-4">
      <div className=" text-black capitalize font-bold text-xl border-b-4 border-blue-500 inline-block pb-1">
        Programming
      </div>
        ...
        <div className="mt-8 grid gap-3 grid-cols-1 md:grid-cols-1   lg:grid-cols-3 xl:gap-4">
          {programming.map((item, index) => {
            ...
            return (
              <div
                key={index}
                className="flex flex-col gap-3 p-16 border border-gray-100 shadow-md transition-all duration-300 hover:shadow-2xl hover:text-white hover:bg-gray-900 hover:scale-105"
              >
